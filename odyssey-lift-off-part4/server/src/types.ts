...
export type ResolversTypes = {
  ...
  IncrementTrackViewsResponse: ResolverTypeWrapper<Omit<IncrementTrackViewsResponse, 'data'> & { data?: Maybe<ResolversTypes['Track']> }>;
...
export type ResolversParentTypes = {
  ...
  ID: Scalars['ID']['output'];
  IncrementTrackViewsResponse: Omit<IncrementTrackViewsResponse, 'data'> & { data?: Maybe<ResolversParentTypes['Track']> };
